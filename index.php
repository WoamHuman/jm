...
<head>
   ...
   <meta charset="utf-8"> 
   <title>北岸的蜜语星球 - 蜜语翻译器,文字加密通话,一键转换,蜜语密码-北岸's blog</title>
   <meta name="keywords" content="蜜语,蜜语翻译,在线加密,蜜语密码,加密通话,在线转码解码WoAMHUMAN's blog">
    <meta name="description" content="可以将文字、字母、数字、代码、标点符号等内容转换成新的文字形式，通过简单的文字以不同的排列顺序来表达不同的内容WoAMHUMAN's blog！">
...
<div class="container" style="padding-top: 10px">
   ...
   <ul id="myTabs" class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item" style="width: 20%;" align="center">
        <a data-toggle="tab" href="#py">破译</a>
      </li>
      <li class="nav-item" style="width: 20%;" align="center">
        <a data-toggle="tab" href="#about">关于</a>
      </li>
      <li class="nav-item" style="width: 20%;" align="center">
        <a href="https://github.com/WoamHuman">Github</a>
      </li>
      <li class="nav-item" style="width: 20%;" align="center">
        <a href="http://wpa.qq.com/msgrd?v=3&uin=2663652847&site=qq&menu=yes">通知</a>
      </li>
    </ul>
      ...
      <div class="tab-pane fade in active" id="jm">
       ...
       <div class="tab-pane fade in" id="about">
         <blockquote class="blockquote">
            <p>北岸的蜜语可以将文字、字母、数字、代码、标点符号等内容转换成新的文字形式，通过简单的文字以不同的排列顺序来表达不同的内容！</p>
            <footer>Designde by WoAMHUMAN's blog</footer>
          </blockquote>
       </div>
</div>
</div>
         ...
         success:function(data){
            if(data.content!='' && data.content!='\u0000' && data.content!='\u000f'){
               ...
               layer.open({
                  ...
                  area: area,
                  skin: 'layui-layer-molv',
                  content:'<div style=""><center><button id="copyBtn" data-clipboard-text="'+htmlspecialchars(data.content)+'" class="btn btn-success btn-xs">复制 <font color=""><b>'+name+'</b></font> 内容</button><hr><code>'+htmlspecialchars(data.content)+'</code><hr><img src="./my.png" width="50"></center></div>'
               });
            }else{
